...
export const FileAttachmentFindFirstSelectSchema: z.ZodType<Prisma.FileAttachmentSelect> = z.object({
...
export const FileAttachmentFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    url: z.boolean().optional(),
    name: z.boolean().optional(),
    type: z.boolean().optional(),
...
export const FileAttachmentFindFirstSchema: z.ZodType<Prisma.FileAttachmentFindFirstArgs> = z.object({ select: FileAttachmentFindFirstSelectSchema.optional(), include: z.lazy(() => FileAttachmentIncludeObjectSchema.optional()), orderBy: z.union([FileAttachmentOrderByWithRelationInputObjectSchema, FileAttachmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: FileAttachmentWhereInputObjectSchema.optional(), cursor: FileAttachmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FileAttachmentScalarFieldEnumSchema, FileAttachmentScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.FileAttachmentFindFirstArgs>;

export const FileAttachmentFindFirstZodSchema = z.object({ select: FileAttachmentFindFirstSelectSchema.optional(), include: z.lazy(() => FileAttachmentIncludeObjectSchema.optional()), orderBy: z.union([FileAttachmentOrderByWithRelationInputObjectSchema, FileAttachmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: FileAttachmentWhereInputObjectSchema.optional(), cursor: FileAttachmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FileAttachmentScalarFieldEnumSchema, FileAttachmentScalarFieldEnumSchema.array()]).optional() }).strict();