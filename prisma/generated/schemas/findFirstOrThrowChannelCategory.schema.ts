...
export const ChannelCategoryFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ChannelCategorySelect> = z.object({
...
export const ChannelCategoryFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    position: z.boolean().optional(),
    serverId: z.boolean().optional(),
...
export const ChannelCategoryFindFirstOrThrowSchema: z.ZodType<Prisma.ChannelCategoryFindFirstOrThrowArgs> = z.object({ select: ChannelCategoryFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ChannelCategoryIncludeObjectSchema.optional()), orderBy: z.union([ChannelCategoryOrderByWithRelationInputObjectSchema, ChannelCategoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: ChannelCategoryWhereInputObjectSchema.optional(), cursor: ChannelCategoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ChannelCategoryScalarFieldEnumSchema, ChannelCategoryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ChannelCategoryFindFirstOrThrowArgs>;

export const ChannelCategoryFindFirstOrThrowZodSchema = z.object({ select: ChannelCategoryFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ChannelCategoryIncludeObjectSchema.optional()), orderBy: z.union([ChannelCategoryOrderByWithRelationInputObjectSchema, ChannelCategoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: ChannelCategoryWhereInputObjectSchema.optional(), cursor: ChannelCategoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ChannelCategoryScalarFieldEnumSchema, ChannelCategoryScalarFieldEnumSchema.array()]).optional() }).strict();