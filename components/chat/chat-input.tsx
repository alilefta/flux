		...
		<div className="px-4 pb-4">
			<div className="relative rounded-xl p-1 flex items-end gap-2 border border-white/10 bg-black/40 focus-within:border-primary/50 focus-within:ring-1 focus-within:ring-primary/50 transition-all">
				...
				<div className="flex items-center gap-1 pb-1 shrink-0">
					<button title="Emoji Selector" className="p-2 rounded-lg text-zinc-400 hover:text-yellow-400 hover:bg-white/10 transition-colors">
						<Smile className="w-5 h-5" />
					</button>
					<button title="Send" className="p-2 rounded-lg bg-white/5 text-zinc-400 hover:text-primary hover:bg-primary/10 transition-colors">
