...
export const ChannelCategoryFindUniqueSchema: z.ZodType<Prisma.ChannelCategoryFindUniqueArgs> = z.object({ select: ChannelCategorySelectObjectSchema.optional(), include: ChannelCategoryIncludeObjectSchema.optional(), where: ChannelCategoryWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.ChannelCategoryFindUniqueArgs>;

export const ChannelCategoryFindUniqueZodSchema = z.object({ select: ChannelCategorySelectObjectSchema.optional(), include: ChannelCategoryIncludeObjectSchema.optional(), where: ChannelCategoryWhereUniqueInputObjectSchema }).strict();