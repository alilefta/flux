...
export const ChannelCategoryFindFirstSelectSchema: z.ZodType<Prisma.ChannelCategorySelect> = z.object({
...
export const ChannelCategoryFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    position: z.boolean().optional(),
    serverId: z.boolean().optional(),
