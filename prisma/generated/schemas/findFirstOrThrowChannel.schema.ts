...
export const ChannelFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ChannelSelect> = z.object({
...
export const ChannelFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    type: z.boolean().optional(),
    profileId: z.boolean().optional(),
