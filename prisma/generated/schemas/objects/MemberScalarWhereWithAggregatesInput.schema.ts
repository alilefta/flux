...
import { EnumMemberRoleWithAggregatesFilterObjectSchema as EnumMemberRoleWithAggregatesFilterObjectSchema } from './EnumMemberRoleWithAggregatesFilter.schema';
...
const memberscalarwherewithaggregatesinputSchema = z.object({
  ...
  role: z.union([z.lazy(() => EnumMemberRoleWithAggregatesFilterObjectSchema), MemberRoleSchema]).optional(),
