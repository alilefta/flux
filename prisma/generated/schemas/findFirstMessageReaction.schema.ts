...
export const MessageReactionFindFirstSelectSchema: z.ZodType<Prisma.MessageReactionSelect> = z.object({
...
export const MessageReactionFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    emoji: z.boolean().optional(),
    messageId: z.boolean().optional(),
    message: z.boolean().optional(),
