...
export const MessageCountOutputTypeCountAttachmentsArgsObjectSchema = makeSchema();
export const MessageCountOutputTypeCountAttachmentsArgsObjectZodSchema = makeSchema();
