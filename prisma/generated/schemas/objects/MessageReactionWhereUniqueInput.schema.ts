...
import { MessageReactionDirectMessageIdProfileIdEmojiCompoundUniqueInputObjectSchema as MessageReactionDirectMessageIdProfileIdEmojiCompoundUniqueInputObjectSchema } from './MessageReactionDirectMessageIdProfileIdEmojiCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  id: z.string().optional(),
  messageId_profileId_emoji: z.lazy(() => MessageReactionMessageIdProfileIdEmojiCompoundUniqueInputObjectSchema).optional(),
  directMessageId_profileId_emoji: z.lazy(() => MessageReactionDirectMessageIdProfileIdEmojiCompoundUniqueInputObjectSchema).optional()
}).strict();
